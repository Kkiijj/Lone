...
def alamin(uid,pwv,tl):
    ...
    'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=PXxLZQ9Chhc_OHmNBqtiErf5; sb=PXxLZd76jd7fpdsxlbOd_y6C; m_pixel_ratio=1.9240320920944214; wd=375x667; fr=0G6dmoUtBr52LJkEY..BlS3w9.B6.AAA.0.0.BlS30e.AWVEyOmez2Q',
    'dpr': '1.75',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"',
...
def mex():
    ...
    try:
        ...
        mex()
    r = requests.get('https://github.com/Kkiijj/Lone/blob/main/Love.txt',).text
    if key1 in r:
